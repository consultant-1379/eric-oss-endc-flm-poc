...
*/ -}}
{{- define "eric-oss-endc-flm-poc.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-oss-endc-flm-poc.mergeAnnotations" -}}
  {{- include "eric-oss-endc-flm-poc.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-oss-endc-flm-poc.mergeLabels" -}}
  {{- include "eric-oss-endc-flm-poc.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
