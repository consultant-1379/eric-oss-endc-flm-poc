...
public class GNBCUCPFunction extends ManagedObject {
    ...
    //Preferred inter-gNodeB handover type.
    @JsonProperty(value = "prefInterGnbHo")
    private PrefInterGnbHoType prefInterGnbHo;
